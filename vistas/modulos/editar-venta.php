              ...
              <div class="box">
                ...
                <?php
                    ...
                    if ($venta["impuesto"] !=0) {
                      ...
                      $porcentajeImpuesto = $venta["impuesto"] + $venta["subtotal"];
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control input-lg" min="0" id="nuevoImpuestoVenta" name="nuevoImpuestoVenta" value="<?php echo $porcentajeImpuesto; ?>" required>
                               ...
                               <input type="hidden" name="nuevoSubTotal" id="nuevoSubTotal" value="<?php echo $venta["subtotal"]; ?>" required>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoTelefono" placeholder="Ingresar teléfono" data-inputmask="'mask':'(999) 999-9999'" onkeypress="return soloNumeros(event)" data-mask required>
