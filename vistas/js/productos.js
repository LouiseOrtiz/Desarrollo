     ...
     $.ajax({
      ...
      success:function(respuesta){
          ...
          datosCategoria.append("idCategoria",respuesta["id_categoria"]);
           ...
           $("#editarCodigoSAT").val(respuesta["codigoSAT"]);

           $("#editarDescripcion").val(respuesta["descripcion"]);

           $("#editarUnidad").val(respuesta["unidad"]);

           $("#editarUnidadSat").val(respuesta["unidad_sat"]);
...
if (editarClave == "KILOGRAMO") {

  $("#editarUnidadSat").val("KGM");

 }else if (editarClave == "KIT") {

  $("#editarUnidadSat").val("KT");

 }else if (editarClave == "LITRO") {

  $("#editarUnidadSat").val("LTR");

 }else if (editarClave == "METRO") {

  $("#editarUnidadSat").val("MTR");

 }else if (editarClave == "PIEZA") {
