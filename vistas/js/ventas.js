      	...
      	success:function(respuesta){
	          ...
	          '<div class="col-xs-6" style="padding-right:0px">'+
	            ...
	            '<div class="input-group">'+
	              ...
	              '<select class="form-control nuevaDescripcionProducto agregarPoducto" id="producto'+numProducto+'" idProducto name="nuevaDescripcionProducto" required>'+
...
function agregarImpuesto(){
	...
	if (impuesto == null) {
		...
		var totalSinImpuesto= Number(precioImpuesto) + Number(precioTotal);

		$("#nuevoTotalVenta").val(totalSinImpuesto);

		$("#totalVenta").val(totalSinImpuesto);
